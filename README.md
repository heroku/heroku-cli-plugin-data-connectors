...
@heroku-cli/plugin-data-connectors/0.0.1 darwin-x64 node-v12.15.0
$ heroku --help [COMMAND]
USAGE
  $ heroku COMMAND
...
...
_See code: [src/commands/data/connectors/index.ts](https://github.com/heroku/heroku-cli-plugin-data-connectors/blob/v0.0.1/src/commands/data/connectors/index.ts)_
...
_See code: [src/commands/data/connectors/create.ts](https://github.com/heroku/heroku-cli-plugin-data-connectors/blob/v0.0.1/src/commands/data/connectors/create.ts)_
...
_See code: [src/commands/data/connectors/destroy.ts](https://github.com/heroku/heroku-cli-plugin-data-connectors/blob/v0.0.1/src/commands/data/connectors/destroy.ts)_
...
_See code: [src/commands/data/connectors/info.ts](https://github.com/heroku/heroku-cli-plugin-data-connectors/blob/v0.0.1/src/commands/data/connectors/info.ts)_
...
_See code: [src/commands/data/connectors/pause.ts](https://github.com/heroku/heroku-cli-plugin-data-connectors/blob/v0.0.1/src/commands/data/connectors/pause.ts)_
...
_See code: [src/commands/data/connectors/resume.ts](https://github.com/heroku/heroku-cli-plugin-data-connectors/blob/v0.0.1/src/commands/data/connectors/resume.ts)_
...
_See code: [src/commands/data/connectors/update.ts](https://github.com/heroku/heroku-cli-plugin-data-connectors/blob/v0.0.1/src/commands/data/connectors/update.ts)_
...
_See code: [src/commands/data/connectors/wait.ts](https://github.com/heroku/heroku-cli-plugin-data-connectors/blob/v0.0.1/src/commands/data/connectors/wait.ts)_
<!-- commandsstop -->
